        ...
        <hr>
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/submit-product-catagory')}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">catagory name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="catagory_name" value="{{old('catagory_name')}}">
                  </div>
                </div>
