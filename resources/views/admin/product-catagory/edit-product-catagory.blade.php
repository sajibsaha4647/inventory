            ...
            <div class="card-body">
                <h4 class="form-header text-uppercase">
                  <i class="fa fa-user-circle-o"></i>
                   product catagory Info
                </h4>
                <form method="post" action="{{url('admin/update-product-catagory/' . $edit->catagory_id)}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">catagory name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="catagory_name" value="{{ $edit->catagory_name}}">
                  </div>
                </div>
