        ...
        <hr>
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/submituser')}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control form-control-square" name="password" value="{{old('password')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-22" class="col-sm-2 col-form-label">repassword</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control form-control-square" name="repassword" value="{{old('repassword')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-23" class="col-sm-2 col-form-label">user role</label>
                  <div class="col-sm-10">
                    <select class="form-control form-control-square" name="role" value="{{old('role')}}">
                        <option>admin</option>
