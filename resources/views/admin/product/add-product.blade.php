        ...
        <hr>
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/submit-product')}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_name" value="{{old('product_name')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product code</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_code" value="{{old('product_code')}}">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    @endphp
                    <select class="form-control form-control-square" name="catagory_id" value="{{old('catagory_id')}}>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    @endphp
                    <select class="form-control form-control-square" name="supplier_id" value="{{old('supplier_id')}}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_godown" value="{{old('product_godown')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product rout</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_rout" value="{{old('product_rout')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product buying date</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control form-control-square" name="product_buy_date" value="{{old('product_buy_date')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product expaire date</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control form-control-square" name="product_expaire_date" value="{{old('product_expaire_date')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product buying price</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_buting_price" value="{{old('product_buting_price')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">product selling price</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="product_selling_price" value="{{old('product_selling_price')}}">
                  </div>
                </div>
                <div class="form-group row">
