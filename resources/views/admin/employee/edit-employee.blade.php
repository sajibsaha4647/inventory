        ...
        <hr>
          <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/update-employee/' . $edit->employee_id)}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">experience</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" value="{{ $edit->experience}}" name="experience" >
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">salary</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" value="{{ $edit->salary}}" name="salary" >
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">vacation</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" value="{{ $edit->vacation}}" name="vacation" >
                  </div>
                </div>
                <div class="form-group row">
