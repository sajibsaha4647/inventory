                    ...
                    @forelse($alluser as $data)
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ url('admin/delete-employee/') }}/{{ $data->employee_id }}"><i class="fa fa-trash"></i></a>
                              <a href="{{ url('admin/hidden-employee/') }}/{{ $data->employee_id }}"><i class="fa fa-eye-slash"></i></a>
                            </td>
                        </tr>
                </tbody>
                @empty
