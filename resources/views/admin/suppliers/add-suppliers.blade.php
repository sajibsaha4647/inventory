        ...
        <hr>
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/submit-suppliers')}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                  <label for="input-23" class="col-sm-2 col-form-label">supplier type</label>
                  <div class="col-sm-10">
                    <select class="form-control form-control-square" name="type" value="{{old('type')}}">
                ...
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">shop</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="shop" value="{{old('shop')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">bank_name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="bank_name" value="{{old('bank_name')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">bank_branch</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="bank_branch" value="{{old('bank_branch')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">bank_account_numer</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="bank_account_numer" value="{{old('bank_account_numer')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">bank_account_name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="bank_account_name" value="{{old('bank_account_name')}}">
                  </div>
                </div>
                <div class="form-group row">
