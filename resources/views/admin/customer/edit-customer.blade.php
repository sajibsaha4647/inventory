        ...
        <hr>
          <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/update-customer/' . $edit->customer_id)}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">shopname</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" value="{{ $edit->shopname}}" name="shopname" >
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">bank_name</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label for="input-21" class="col-sm-2 col-form-label">bank_account_no</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" value="{{ $edit->bank_account_no}}" name="bank_account_no" >
                  </div>
                </div>
                <div class="form-group row">
