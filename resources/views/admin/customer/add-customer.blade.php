        ...
        <hr>
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/submit-customer')}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">shopname</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="shopname" value="{{old('shopname')}}">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">bank_account_no</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="bank_account_no" value="{{old('bank_account_no')}}">
                  </div>
                </div>
                <div class="form-group row">
