        ...
        <hr>
          <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{url('admin/update-expence/' . $edit->expence_id)}}"  class="form-bordered" enctype="multipart/form-data">
                    @csrf
                <div class="form-group row">
                  <label for="input-18" class="col-sm-2 col-form-label">expence details</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="expence_details" value="{{ $edit->expence_details}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-20" class="col-sm-2 col-form-label">expence amount</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-square" name="expence_amount"value="{{ $edit->expence_amount}}">
                  </div>
                </div>
