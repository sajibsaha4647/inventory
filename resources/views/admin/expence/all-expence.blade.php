                ...
                <tbody>
                    @forelse($alluser as $data)
                        <tr>
                            ...
                            <td>{{$data->expence_month}}</td>
                            <td>{{$data->expence_year}}</td>
                            <td>
                              <img src="{{asset('public/uploads/expence')}}/{{ $data->expence_img }}" alt="">
                            </td>
                            <td>
                              <a href="{{ url('admin/edit-expence/') }}/{{ $data->expence_id }}"><i class="fa fa-pencil-square"></i></a>
                              <a href="{{ url('admin/delete-expence/') }}/{{ $data->expence_id }}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                </tbody>
                @empty
